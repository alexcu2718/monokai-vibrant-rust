...
call s:HL("rustGenKeyword",     s:red,      "",     "italic")

" C++
call s:HL("cppCast",            s:cyan,     "",     "italic")
call s:HL("cppStaticCast",      s:cyan,     "",     "italic")
call s:HL("cppDynamicCast",     s:cyan,     "",     "italic")
call s:HL("cppConstCast",       s:cyan,     "",     "italic")
call s:HL("cppReinterpretCast", s:cyan,     "",     "italic")
call s:HL("cppOperatorOverload", s:cyan,    "",     "italic")
call s:HL("cppTemplate",        s:cyan,     "",     "italic")
call s:HL("cppTypename",        s:cyan,     "",     "italic")
call s:HL("cppFriend",          s:cyan,     "",     "italic")
call s:HL("cppExplicit",        s:cyan,     "",     "italic")
call s:HL("cppVirtual",         s:cyan,     "",     "italic")
call s:HL("cppOverride",        s:cyan,     "",     "italic")
call s:HL("cppFinal",           s:cyan,     "",     "italic")
call s:HL("cppNoexcept",        s:cyan,     "",     "italic")
call s:HL("cppConstexpr",       s:cyan,     "",     "italic")
call s:HL("cppConsteval",       s:cyan,     "",     "italic")
call s:HL("cppConstinit",       s:cyan,     "",     "italic")
call s:HL("cppDecltype",        s:cyan,     "",     "italic")
call s:HL("cppAlignas",         s:cyan,     "",     "italic")
call s:HL("cppAlignof",         s:cyan,     "",     "italic")
call s:HL("cppThreadLocal",     s:cyan,     "",     "italic")
